...
class WGA
{
    ...
    {
        $r = @file_get_contents('https://k.os120.com/api/wga/verify?out_type=json&des=正版验证&domain=' . $_SERVER['SERVER_NAME'], false, stream_context_create(array('http' => array('method' => "GET",'timeout' => 3))));
        if ($r) {
