var plugins_thirdpartylogin_form_login = $('.user-form-container .am-nbfc, .login-modal-container .am-nbfc'),
...
if (plugins_thirdpartylogin_form_login.length > 0) { // 登录
  if (plugins_thirdpartylogin_bind() === false) {
    ...
    plugins_thirdpartylogin_form_login.prepend(plugins_thirdpartylogin_icons);
  }
